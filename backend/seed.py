...
PLAN_ITEMS = [
    {"plan_id": "P001", "type": "设备", "name": "回转窑 1#", "vendor": "江苏鹏飞",
     "order_no": "PF-2025-0312", "expected_arrival": months_ago(2),
     "actual_arrival": days_ago(10), "status": "已到货", "delay_days": 10},
    {"plan_id": "P001", "type": "设备", "name": "回转窑 2#", "vendor": "江苏鹏飞",
     "order_no": "PF-2025-0313", "expected_arrival": months_ago(1),
     "actual_arrival": None, "status": "部分到货", "delay_days": 30},
    {"plan_id": "P001", "type": "物料", "name": "工业级碳酸锂原料", "vendor": "海外长协",
     "order_no": "LA-2026-Q2", "expected_arrival": months_ahead(1),
     "actual_arrival": None, "status": "已签", "delay_days": 0},
    {"plan_id": "P002", "type": "设备", "name": "砂磨机 1#", "vendor": "德国耐驰",
     "order_no": "NE-2026-001", "expected_arrival": months_ago(3),
     "actual_arrival": months_ago(1), "status": "已调试", "delay_days": 0},
    {"plan_id": "P002", "type": "设备", "name": "砂磨机 2#", "vendor": "德国耐驰",
     "order_no": "NE-2026-002", "expected_arrival": months_ago(1),
     "actual_arrival": None, "status": "部分到货", "delay_days": 25},
    {"plan_id": "P003", "type": "设备", "name": "烧结炉", "vendor": "苏州博华",
     "order_no": "BH-2026-008", "expected_arrival": months_ahead(2),
     "actual_arrival": None, "status": "已签", "delay_days": 0},
    {"plan_id": "P004", "type": "设备", "name": "石墨化炉 1#", "vendor": "湖南顶立",
     "order_no": "DL-2026-005", "expected_arrival": months_ago(2),
     "actual_arrival": months_ago(2), "status": "已投产", "delay_days": 0},
    {"plan_id": "P005", "type": "设备", "name": "反应釜 1#", "vendor": "江苏乐科",
     "order_no": "LK-2026-001", "expected_arrival": months_ahead(1),
     "actual_arrival": None, "status": "已签", "delay_days": 0},
]
