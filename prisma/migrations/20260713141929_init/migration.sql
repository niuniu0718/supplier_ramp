...
CREATE TABLE "HealthSnapshot" (
    ...
    CONSTRAINT "HealthSnapshot_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "Material" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "FollowTask" (
    ...
    "title" TEXT NOT NULL,
    "ownerId" TEXT NOT NULL,
    "collaboratorNames" TEXT NOT NULL DEFAULT '',
...
CREATE TABLE "ExpansionPlan" (
    ...
    "stage" TEXT NOT NULL,
    "progress" INTEGER NOT NULL,
    "expectedProgress" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "HealthSnapshot_materialId_weekDate_key" ON "HealthSnapshot"("materialId", "weekDate");
