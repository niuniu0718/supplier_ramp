...
export const COMMISSIONING_TYPES: CommissioningType[] = [
  { order: 1, key: 'SINGLE_TRIAL', name: '单机试产', standard: '设备空载运行2h无异常' },
  { order: 2, key: 'INTEGRATED_TRIAL', name: '联动试产', standard: '全流程联动运行8h无异常' },
  { order: 3, key: 'FEED_TRIAL', name: '投料试产', standard: '按配方投料，产出合格产品' },
